...
int main(){
    ...
    const int *p_var3 {&var1}; //Pointer to const - can't
    const int * const p_var4 {&var1}; // Const point to const data
    int * const p_var5 {&var1}; //Const pointer to non const data
    */

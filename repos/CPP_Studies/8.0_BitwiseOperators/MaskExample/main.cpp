...
void use_options_v0(bool flag0, bool flag1, bool flag2, bool flag3, bool flag4,
                    bool flag5, bool flag6, bool flag7)
{
...
{
    std::cout << "bit0 is: " << ((flags & mask_bit_0)) << ", do something with it." << std::endl;
    std::cout << "bit1 is: " << ((flags & mask_bit_1)) << ", do something with it." << std::endl;
    std::cout << "bit2 is: " << ((flags & mask_bit_2)) << ", do something with it." << std::endl;
    std::cout << "bit3 is: " << ((flags & mask_bit_3)) << ", do something with it." << std::endl;
    std::cout << "bit4 is: " << ((flags & mask_bit_4)) << ", do something with it." << std::endl;
    std::cout << "bit5 is: " << ((flags & mask_bit_5)) << ", do something with it." << std::endl;
    std::cout << "bit6 is: " << ((flags & mask_bit_6)) << ", do something with it." << std::endl;
    std::cout << "bit7 is: " << ((flags & mask_bit_7)) << ", do something with it." << std::endl;
}
